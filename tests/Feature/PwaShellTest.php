...
class PwaShellTest extends TestCase
{
    public function test_app_shell_includes_ios_pwa_launch_metadata_and_boot_screen(): void
    {
        ...
        $this->assertStringContainsString('images/splash/ios-splash-light-1170x2532.png', $html);
        $this->assertStringContainsString('images/splash/ios-splash-dark-2532x1170.png', $html);
        ...
        $this->assertStringContainsString('class="app-loading-screen"', $html);
        $this->assertStringContainsString('role="status"', $html);
        $this->assertStringContainsString('aria-live="polite"', $html);
        $this->assertStringContainsString('davvy.png', $html);
        $this->assertStringContainsString('davvy_dark.png', $html);
        $this->assertStringContainsString('Loading Davvy...', $html);
